  ...
  return (
    <div>
        <div className="w-full flex flex-col items-center gap-10">
            <h1 className="w-full text-6xl text-center text-white font-bold">Register page</h1>
            ...
            <div className="flex flex-col justify-center gap-4 border-gray-300 border-2 p-5 w-[25vw] h-[25vw]">
                ...
                <div className="border-2 py-2 border-white">
                    <input className="text-white pl-3 w-full py-2 outline-none" type="text" placeholder="Name" />
