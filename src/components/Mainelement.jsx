...
import DogImagePreloader from './Preloader/Preloader';
...
const Mainelement = () => {
    ...
    return (
        <>
            {loading && <DogImagePreloader />}


            {!loading && <main>
                <div className="images">
                    <img id='shader1' src="/shader1.png" alt="shader1" />
                    <img id='shader2' src="/shader2.png" alt="shader2" />
                    <img id='shader3' src="/shader3.png" alt="shader3" />
                    <img id='shader4' src="/shader4.png" alt="shader4" />
                    <img id='shader5' src="/shader5.png" alt="shader5" />
                    <img id='shader6' src="/shader6.png" alt="shader6" />
                    <img id='shader7' src="/shader7.png" alt="shader7" />
                </div>
                <Canvas
                    id='canvas-elem'
                    style={{
